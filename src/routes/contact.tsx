  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(
        authErrorMessage(
          caught,
          "We could not send that message. Please email gracefield.liveincare@gracefieldliveincare.com or call us.",
        ),
      );
    } finally {
      setBusy(false);
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:gap-16">
          ...
          <aside className="pt-1 lg:pt-5">
            ...
            <div className="mt-8 space-y-7">
              ...
              <div className="grid grid-cols-[auto_minmax(0,1fr)] gap-4"><Mail className="mt-1 h-6 w-6 text-brand-gold" aria-hidden="true" /><div><h3 className="font-heading text-lg font-extrabold text-primary">Email</h3><a className="mt-1 block break-all text-base text-muted-foreground underline decoration-brand-gold underline-offset-4" href="mailto:gracefield.liveincare@gracefieldliveincare.com">gracefield.liveincare@gracefieldliveincare.com</a><a className="mt-1 block break-all text-base text-muted-foreground underline decoration-brand-gold underline-offset-4" href="mailto:gracefieldliveincare@gmail.com">gracefieldliveincare@gmail.com</a></div></div>

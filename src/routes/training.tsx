...
import careTraining from "@/assets/gracefield-care-training.jpg";
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20 lg:px-12">
        <img
          src={careTraining}
          alt="Gracefield carers in a training session, going through person-centred care with an older person"
          width={1600}
          height={1104}
          className="image-frame aspect-[16/7] w-full rounded-[2rem] object-cover"
        />
